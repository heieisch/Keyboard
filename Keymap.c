...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_RAISE] = LAYOUT(
    //,--------+--------+--------+--------+--------+--------.   ,--------+--------+--------+--------+--------+--------.
       KC_ESC , KC_BSLS, KC_CIRC, KC_EXLM, KC_AMPR, KC_PIPE,     KC_AT  , KC_EQL , KC_PLUS, KC_ASTR, KC_PERC, KC_MINS,
    //|--------+--------+--------+--------+--------+--------|   |--------+--------+--------+--------+--------+--------|
       KC_TAB , KC_LPRN, KC_LBRC, KC_RBRC, KC_RPRN, _______,     KC_LEFT, KC_DOWN,  KC_UP , KC_RGHT, KC_INS , KC_QUOT,
    //|--------+--------+--------+--------+--------+--------|   |--------+--------+--------+--------+--------+--------|
       KC_LSFT, KC_HASH, KC_GRV , _______, _______, KC_TILD,     KC_HOME, KC_PGDN, KC_PGUP, KC_END , KC_PSCR, _______,
    //`--------+--------+--------+--------+--------+--------/   \--------+--------+--------+--------+--------+--------'
                         KC_LALT, KC_G_EN, MO(3)  , KC_C_BS,     KC_C_BS, _______, KC_G_JA, KC_A_ESC
    //                  `--------+--------+--------+--------'   `--------+--------+--------+--------'
    ),
    ...
    //`--------+--------+--------+--------+--------+--------/   \--------+--------+--------+--------+--------+--------'
                         KC_A_ESC, KC_G_EN, _______, KC_C_BS,    KC_C_BS, MO(3)  , KC_G_JA, KC_A_ESC
    //                  `--------+--------+--------+--------'   `--------+--------+--------+--------'
    ),
    [_ADJUST] = LAYOUT(
    //,--------+--------+--------+--------+--------+--------.   ,--------+--------+--------+--------+--------+--------.
    ...
    //`--------+--------+--------+--------+--------+--------/   \--------+--------+--------+--------+--------+--------'
                         QK_BOOT, KC_G_EN, _______ , KC_C_BS,     KC_C_BS, _______, KC_G_JA, QK_BOOT
    //                  `--------+--------+--------+--------'   `--------+--------+--------+--------'
    ),
};
